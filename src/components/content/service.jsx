      ...
      <div className={serviceStyle.holdCard}>
        <div className={serviceStyle.flipCard}>
          <div className={serviceStyle.flipCardInner}>
            <div className={serviceStyle.flipCardFront}>
              <img
                src="https://portfo.jstemplate.net/wp-content/uploads/2021/02/Web-Development.png"
                alt="Avatar"
        ...
        <div className={serviceStyle.flipCard}>
          <div className={serviceStyle.flipCardInner}>
            <div className={serviceStyle.flipCardFront}>
              <img
                src="https://portfo.jstemplate.net/wp-content/uploads/2021/02/UI-UX-Design.png"
                alt="Avatar"
                style={{ width: "150px", height: "150px" }}
              />
