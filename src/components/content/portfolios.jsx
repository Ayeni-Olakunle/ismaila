...
import porfolioStyle from "./portfolios.module.scss";
    ...
    <section>
      <div>
        ...
        <div className={porfolioStyle.holdHeaderPTage}>
          <p className={porfolioStyle.headerPTage}>
        ...
        <div className={porfolioStyle.holdUnorderedList}>
          <ul className={porfolioStyle.unorderedList}>
            <li
              className={
                current === "All Categories" ? porfolioStyle.active : null
              }
              onClick={() => {
            ...
            <li
              className={
                current === "Front End Projects" ? porfolioStyle.active : null
              }
              onClick={() => {
            ...
            <li
              className={
                current === "Mobile Application Projects"
                  ? porfolioStyle.active
                  : null
              }
              onClick={() => {
            ...
            <li
              className={
                current === "Back End Projects" ? porfolioStyle.active : null
              }
              onClick={() => {
