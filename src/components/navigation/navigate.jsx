...
import navStyle from "./navigate.module.scss";
        ...
        <ul className={navStyle.holdList}>
          <li onClick={ulrChange}>
            <Link to="/">
              <AiFillHome
                className={
                  currentPath === "/" ? navStyle.icons2 : navStyle.icons
                }
              />
            </Link>
          </li>
          <li onClick={ulrChange}>
            <Link to="/services">
              <FaFileCode
                className={
                  currentPath === "/services" ? navStyle.icons2 : navStyle.icons
                }
              />
            </Link>
          </li>
          ...
          <li onClick={ulrChange}>
            <Link to="/contact">
              <RiMessage2Line
                className={
                  currentPath === "/contact" ? navStyle.icons2 : navStyle.icons
                }
              />
            </Link>
          </li>
